...
function Home() {
    ...
    // Step 1: fetch all categories and pick the first one dynamically
    useEffect(() => {
    ...
    // Step 2: once we have a categoryID, fetch its courses
    useEffect(() => {
    ...
    <div>
        ...
        <div className='mx-auto box-content w-full max-w-maxContentTab px- py-12 lg:max-w-maxContent'>
            ...
            </h2>
            {
                ...
                : <p className='text-richblack-400 text-sm'>No courses available yet.</p>
            }
        </div>
                ...
                <div className='flex flex-row gap-5 mb-10 mt-[95px]'>
                    ...
                    <div className='flex flex-col gap-10 w-[40%] items-start'>
                        <div className='text-[16px]'>
                            The modern Coursiqo is the dictates its own terms. Today, to be a competitive specialist requires more than professional skills.
                        </div>
                        <CTAButton active={true} linkto={"/signup"}>
                            <div>Learn more</div>
                        </CTAButton>
