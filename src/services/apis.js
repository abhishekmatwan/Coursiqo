...
export const studyMaterialEndpoints = {
  CREATE_STUDY_MATERIAL_API: BASE_URL + "/study-material/create",
  DELETE_STUDY_MATERIAL_API: BASE_URL + "/study-material/delete",
  GET_STUDY_MATERIALS_API: BASE_URL + "/study-material/getBySubSection",
};
